...
| TIMING  | TYPE  | TOPIC  |
|:-:|---|---|
| 10 min  | [Introduction](#introduction)   | Matplotlib, seaborn  |
...
<a name="Matplotlib, seaborn, plotly"></a>
## Introduction: Matplotlib, seaborn, plotly(10 mins)
...
- Use the "classic-rock-raw-data.csv" file [here](https://github.com/fivethirtyeight/data) and use seaborn, plotly, or to create a visualization. Justify why you chose one plotting tool over the others.
...
and create visualizations using seaborn, or matplotlib. Your choice, but
